...
class TinderBot():
    ...
    def open_tinder(self):
        ...
        login = self.driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/main/div[1]/div/div/div/div/header/div/div[2]/div[2]/a/div[2]/div[2]')
        login.click()
        sleep(3)
        self.facebook_login()
        ...
        sleep(6)
        try:
            allow_location_button = self.driver.find_element(By.XPATH, '//*[@id="t-1917074667"]/main/div/div/div/div[3]/button[1]')
        ...
        try:
            notifications_button = self.driver.find_element(By.XPATH, '/html/body/div[2]/main/div/div/div/div[3]/button[2]')
    ...
    def facebook_login(self):
        ...
        # cookies_accept_button = self.driver.find_element(By.XPATH, '/html/body/div[2]/div[2]/div/div/div/div/div[3]/button[1]')
        # cookies_accept_button.click()

        # login to FB

        email_field = self.driver.find_element(By.XPATH, '/html/body/div/div[2]/div[1]/form/div/div[1]/div/input')
        pw_field = self.driver.find_element(By.XPATH, '/html/body/div/div[2]/div[1]/form/div/div[2]/div/input')
        login_button = self.driver.find_element(By.XPATH, '/html/body/div/div[2]/div[1]/form/div/div[3]/label[2]/input')
    ...
    def get_matches(self):
        match_profiles = self.driver.find_elements(By.CLASS_NAME, 'matchListItem')
        message_links = []
    ...
    def send_message(self, link):
        ...
        sleep(2)
        text_area = self.driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/main/div[1]/div/div/div/div[1]/div/div/div[3]/form/textarea')
